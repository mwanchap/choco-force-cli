...
$url        = 'https://github.com/ForceCLI/force/releases/download/v0.24.3/force_windows_386.exe' # download url, HTTPS preferred
$url64      = 'https://github.com/ForceCLI/force/releases/download/v0.24.3/force_windows_amd64.exe' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
